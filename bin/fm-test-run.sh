...
family_for_basename() {
  case "$1" in
    ...
    fm-pr-reviewers.test.sh|fm-pr-state.test.sh|fm-adversarial-review.test.sh|\
...
portable_serial_weight_hints() {
  cat <<'EOF'
tests/fm-adversarial-review.test.sh 18516
...
tests/fm-backlog-read-bound.test.sh 24059
tests/fm-bearings-board-lavish-live-e2e.test.sh 47
...
tests/fm-calm-claude-mod-live-e2e.test.sh 210
tests/fm-calm-claude-mod-plugin.test.sh 44
tests/fm-calm-claude-mod.test.sh 955
tests/fm-calm-pi-extension.test.sh 256
tests/fm-check-unregister.test.sh 481
tests/fm-ci-workflow.test.sh 1373
...
tests/fm-claude-trust.test.sh 10304
tests/fm-cmux-claude-composer-live-e2e.test.sh 23
tests/fm-codex-continuity-live-e2e.test.sh 21
tests/fm-codex-hook-layer-live-e2e.test.sh 190
tests/fm-composer-codex-idle-live-e2e.test.sh 45
tests/fm-composer-matrix-live-e2e.test.sh 23
tests/fm-contributions.test.sh 34088
...
tests/fm-gemini-harness.test.sh 616
...
tests/fm-harness-precedence.test.sh 3570
tests/fm-herdr-attached-viewer-live-e2e.test.sh 19000
tests/fm-herdr-pi-stale-registration-live-e2e.test.sh 203
...
tests/fm-pi-codex-native.test.sh 195
...
tests/fm-pr-reviewers.test.sh 145
tests/fm-pr-state-live-e2e.test.sh 33
tests/fm-pr-state.test.sh 384
...
tests/fm-rovo-harness.test.sh 14196
tests/fm-rovo-signals-live-e2e.test.sh 204
...
tests/fm-send-agy-confirm.test.sh 3383
...
tests/fm-stat-shadowing.test.sh 33
...
tests/fm-tasks-axi.test.sh 1427
